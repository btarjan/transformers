...
##Train XLnet with xlnet-base-cased config on CC data
#####################################################
...
python run_language_modeling.py \
    --output_dir ./models/cc-xlnet-v1 \
    --model_type xlnet \
    --config_name ./models/xlnet-base-cased \
    --tokenizer_name ./models/cc-SentencePiece-xlnet \
    --do_train \
    --train_data_file=$TRAIN_FILE \
    --do_eval \
    --eval_data_file=$TEST_FILE \
